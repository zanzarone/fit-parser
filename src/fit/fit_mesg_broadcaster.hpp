...
#include "fit_srm_record_mesg_listener.hpp"
#include "fit_srm_comment_mesg_listener.hpp"
#include "fit_srm_user_profile_mesg_listener.hpp"
#include "fit_srm_bike_profile_mesg_listener.hpp"
#include "fit_srm_wifi_profile_mesg_listener.hpp"
#include "fit_srm_display_profile_mesg_listener.hpp"
#include "fit_srm_widget_profile_mesg_listener.hpp"
#include "fit_srm_device_settings_mesg_listener.hpp"
#include "fit_tbd_ff0a_mesg_listener.hpp"
#include "fit_tbd_ff0b_mesg_listener.hpp"
#include "fit_srm_totals_mesg_listener.hpp"
#include "fit_srm_session_mesg_listener.hpp"
#include "fit_srm_compatibility_mesg_listener.hpp"
#include "fit_srm_indoor_settings_mesg_listener.hpp"
#include "fit_srm_indoor_gear_offset_mesg_listener.hpp"
#include "fit_srm_workout_step_mesg_listener.hpp"
#include "fit_srm_workout_info_mesg_listener.hpp"
#include "fit_srm_workout_interval_mesg_listener.hpp"
#include "fit_srm_gateway_mesg_listener.hpp"
#include "fit_srm_gateway_credentials_mesg_listener.hpp"
#include "fit_srm_gateway_token_mesg_listener.hpp"
#include "fit_srm_network_streaming_mesg_listener.hpp"
#include "fit_srm_altitude_offset_mesg_listener.hpp"
#include "fit_srm_summary_db_mesg_listener.hpp"
#include "fit_srm_ftp_db_item_mesg_listener.hpp"
#include "fit_srm_auto_ftp_info_mesg_listener.hpp"
#include "fit_srm_gps_altitude_point_mesg_listener.hpp"
#include "fit_srm_torque_mesg_listener.hpp"
#include "fit_srm_wo_compatibility_mesg_listener.hpp"
...
public:
    ...
    void AddListener(SrmRecordMesgListener& srmRecordMesgListener);
    void RemoveListener(SrmRecordMesgListener& srmRecordMesgListener);
    void AddListener(SrmCommentMesgListener& srmCommentMesgListener);
    void RemoveListener(SrmCommentMesgListener& srmCommentMesgListener);
    void AddListener(SrmUserProfileMesgListener& srmUserProfileMesgListener);
    void RemoveListener(SrmUserProfileMesgListener& srmUserProfileMesgListener);
    void AddListener(SrmBikeProfileMesgListener& srmBikeProfileMesgListener);
    void RemoveListener(SrmBikeProfileMesgListener& srmBikeProfileMesgListener);
    void AddListener(SrmWifiProfileMesgListener& srmWifiProfileMesgListener);
    void RemoveListener(SrmWifiProfileMesgListener& srmWifiProfileMesgListener);
    void AddListener(SrmDisplayProfileMesgListener& srmDisplayProfileMesgListener);
    void RemoveListener(SrmDisplayProfileMesgListener& srmDisplayProfileMesgListener);
    void AddListener(SrmWidgetProfileMesgListener& srmWidgetProfileMesgListener);
    void RemoveListener(SrmWidgetProfileMesgListener& srmWidgetProfileMesgListener);
    void AddListener(SrmDeviceSettingsMesgListener& srmDeviceSettingsMesgListener);
    void RemoveListener(SrmDeviceSettingsMesgListener& srmDeviceSettingsMesgListener);
    void AddListener(TbdFf0aMesgListener& tbdFf0aMesgListener);
    void RemoveListener(TbdFf0aMesgListener& tbdFf0aMesgListener);
    void AddListener(TbdFf0bMesgListener& tbdFf0bMesgListener);
    void RemoveListener(TbdFf0bMesgListener& tbdFf0bMesgListener);
    void AddListener(SrmTotalsMesgListener& srmTotalsMesgListener);
    void RemoveListener(SrmTotalsMesgListener& srmTotalsMesgListener);
    void AddListener(SrmSessionMesgListener& srmSessionMesgListener);
    void RemoveListener(SrmSessionMesgListener& srmSessionMesgListener);
    void AddListener(SrmCompatibilityMesgListener& srmCompatibilityMesgListener);
    void RemoveListener(SrmCompatibilityMesgListener& srmCompatibilityMesgListener);
    void AddListener(SrmIndoorSettingsMesgListener& srmIndoorSettingsMesgListener);
    void RemoveListener(SrmIndoorSettingsMesgListener& srmIndoorSettingsMesgListener);
    void AddListener(SrmIndoorGearOffsetMesgListener& srmIndoorGearOffsetMesgListener);
    void RemoveListener(SrmIndoorGearOffsetMesgListener& srmIndoorGearOffsetMesgListener);
    void AddListener(SrmWorkoutStepMesgListener& srmWorkoutStepMesgListener);
    void RemoveListener(SrmWorkoutStepMesgListener& srmWorkoutStepMesgListener);
    void AddListener(SrmWorkoutInfoMesgListener& srmWorkoutInfoMesgListener);
    void RemoveListener(SrmWorkoutInfoMesgListener& srmWorkoutInfoMesgListener);
    void AddListener(SrmWorkoutIntervalMesgListener& srmWorkoutIntervalMesgListener);
    void RemoveListener(SrmWorkoutIntervalMesgListener& srmWorkoutIntervalMesgListener);
    void AddListener(SrmGatewayMesgListener& srmGatewayMesgListener);
    void RemoveListener(SrmGatewayMesgListener& srmGatewayMesgListener);
    void AddListener(SrmGatewayCredentialsMesgListener& srmGatewayCredentialsMesgListener);
    void RemoveListener(SrmGatewayCredentialsMesgListener& srmGatewayCredentialsMesgListener);
    void AddListener(SrmGatewayTokenMesgListener& srmGatewayTokenMesgListener);
    void RemoveListener(SrmGatewayTokenMesgListener& srmGatewayTokenMesgListener);
    void AddListener(SrmNetworkStreamingMesgListener& srmNetworkStreamingMesgListener);
    void RemoveListener(SrmNetworkStreamingMesgListener& srmNetworkStreamingMesgListener);
    void AddListener(SrmAltitudeOffsetMesgListener& srmAltitudeOffsetMesgListener);
    void RemoveListener(SrmAltitudeOffsetMesgListener& srmAltitudeOffsetMesgListener);
    void AddListener(SrmSummaryDbMesgListener& srmSummaryDbMesgListener);
    void RemoveListener(SrmSummaryDbMesgListener& srmSummaryDbMesgListener);
    void AddListener(SrmFtpDbItemMesgListener& srmFtpDbItemMesgListener);
    void RemoveListener(SrmFtpDbItemMesgListener& srmFtpDbItemMesgListener);
    void AddListener(SrmAutoFtpInfoMesgListener& srmAutoFtpInfoMesgListener);
    void RemoveListener(SrmAutoFtpInfoMesgListener& srmAutoFtpInfoMesgListener);
    void AddListener(SrmGpsAltitudePointMesgListener& srmGpsAltitudePointMesgListener);
    void RemoveListener(SrmGpsAltitudePointMesgListener& srmGpsAltitudePointMesgListener);
    void AddListener(SrmTorqueMesgListener& srmTorqueMesgListener);
    void RemoveListener(SrmTorqueMesgListener& srmTorqueMesgListener);
    void AddListener(SrmWoCompatibilityMesgListener& srmWoCompatibilityMesgListener);
    void RemoveListener(SrmWoCompatibilityMesgListener& srmWoCompatibilityMesgListener);
...
private:
    ...
    std::vector<SrmRecordMesgListener *> srmRecordMesgListeners;
    std::vector<SrmCommentMesgListener *> srmCommentMesgListeners;
    std::vector<SrmUserProfileMesgListener *> srmUserProfileMesgListeners;
    std::vector<SrmBikeProfileMesgListener *> srmBikeProfileMesgListeners;
    std::vector<SrmWifiProfileMesgListener *> srmWifiProfileMesgListeners;
    std::vector<SrmDisplayProfileMesgListener *> srmDisplayProfileMesgListeners;
    std::vector<SrmWidgetProfileMesgListener *> srmWidgetProfileMesgListeners;
    std::vector<SrmDeviceSettingsMesgListener *> srmDeviceSettingsMesgListeners;
    std::vector<TbdFf0aMesgListener *> tbdFf0aMesgListeners;
    std::vector<TbdFf0bMesgListener *> tbdFf0bMesgListeners;
    std::vector<SrmTotalsMesgListener *> srmTotalsMesgListeners;
    std::vector<SrmSessionMesgListener *> srmSessionMesgListeners;
    std::vector<SrmCompatibilityMesgListener *> srmCompatibilityMesgListeners;
    std::vector<SrmIndoorSettingsMesgListener *> srmIndoorSettingsMesgListeners;
    std::vector<SrmIndoorGearOffsetMesgListener *> srmIndoorGearOffsetMesgListeners;
    std::vector<SrmWorkoutStepMesgListener *> srmWorkoutStepMesgListeners;
    std::vector<SrmWorkoutInfoMesgListener *> srmWorkoutInfoMesgListeners;
    std::vector<SrmWorkoutIntervalMesgListener *> srmWorkoutIntervalMesgListeners;
    std::vector<SrmGatewayMesgListener *> srmGatewayMesgListeners;
    std::vector<SrmGatewayCredentialsMesgListener *> srmGatewayCredentialsMesgListeners;
    std::vector<SrmGatewayTokenMesgListener *> srmGatewayTokenMesgListeners;
    std::vector<SrmNetworkStreamingMesgListener *> srmNetworkStreamingMesgListeners;
    std::vector<SrmAltitudeOffsetMesgListener *> srmAltitudeOffsetMesgListeners;
    std::vector<SrmSummaryDbMesgListener *> srmSummaryDbMesgListeners;
    std::vector<SrmFtpDbItemMesgListener *> srmFtpDbItemMesgListeners;
    std::vector<SrmAutoFtpInfoMesgListener *> srmAutoFtpInfoMesgListeners;
    std::vector<SrmGpsAltitudePointMesgListener *> srmGpsAltitudePointMesgListeners;
    std::vector<SrmTorqueMesgListener *> srmTorqueMesgListeners;
    std::vector<SrmWoCompatibilityMesgListener *> srmWoCompatibilityMesgListeners;
};
