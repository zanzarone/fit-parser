...
void MesgBroadcaster::AddListener(SrmRecordMesgListener& srmRecordMesgListener)
{
   srmRecordMesgListeners.push_back(&srmRecordMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmRecordMesgListener& srmRecordMesgListener)
{
    std::vector<SrmRecordMesgListener *>::iterator it = std::find(srmRecordMesgListeners.begin(), srmRecordMesgListeners.end(), &srmRecordMesgListener);
    if (srmRecordMesgListeners.end() != it)
    srmRecordMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmCommentMesgListener& srmCommentMesgListener)
{
   srmCommentMesgListeners.push_back(&srmCommentMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmCommentMesgListener& srmCommentMesgListener)
{
    std::vector<SrmCommentMesgListener *>::iterator it = std::find(srmCommentMesgListeners.begin(), srmCommentMesgListeners.end(), &srmCommentMesgListener);
    if (srmCommentMesgListeners.end() != it)
    srmCommentMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmUserProfileMesgListener& srmUserProfileMesgListener)
{
   srmUserProfileMesgListeners.push_back(&srmUserProfileMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmUserProfileMesgListener& srmUserProfileMesgListener)
{
    std::vector<SrmUserProfileMesgListener *>::iterator it = std::find(srmUserProfileMesgListeners.begin(), srmUserProfileMesgListeners.end(), &srmUserProfileMesgListener);
    if (srmUserProfileMesgListeners.end() != it)
    srmUserProfileMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmBikeProfileMesgListener& srmBikeProfileMesgListener)
{
   srmBikeProfileMesgListeners.push_back(&srmBikeProfileMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmBikeProfileMesgListener& srmBikeProfileMesgListener)
{
    std::vector<SrmBikeProfileMesgListener *>::iterator it = std::find(srmBikeProfileMesgListeners.begin(), srmBikeProfileMesgListeners.end(), &srmBikeProfileMesgListener);
    if (srmBikeProfileMesgListeners.end() != it)
    srmBikeProfileMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmWifiProfileMesgListener& srmWifiProfileMesgListener)
{
   srmWifiProfileMesgListeners.push_back(&srmWifiProfileMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmWifiProfileMesgListener& srmWifiProfileMesgListener)
{
    std::vector<SrmWifiProfileMesgListener *>::iterator it = std::find(srmWifiProfileMesgListeners.begin(), srmWifiProfileMesgListeners.end(), &srmWifiProfileMesgListener);
    if (srmWifiProfileMesgListeners.end() != it)
    srmWifiProfileMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmDisplayProfileMesgListener& srmDisplayProfileMesgListener)
{
   srmDisplayProfileMesgListeners.push_back(&srmDisplayProfileMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmDisplayProfileMesgListener& srmDisplayProfileMesgListener)
{
    std::vector<SrmDisplayProfileMesgListener *>::iterator it = std::find(srmDisplayProfileMesgListeners.begin(), srmDisplayProfileMesgListeners.end(), &srmDisplayProfileMesgListener);
    if (srmDisplayProfileMesgListeners.end() != it)
    srmDisplayProfileMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmWidgetProfileMesgListener& srmWidgetProfileMesgListener)
{
   srmWidgetProfileMesgListeners.push_back(&srmWidgetProfileMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmWidgetProfileMesgListener& srmWidgetProfileMesgListener)
{
    std::vector<SrmWidgetProfileMesgListener *>::iterator it = std::find(srmWidgetProfileMesgListeners.begin(), srmWidgetProfileMesgListeners.end(), &srmWidgetProfileMesgListener);
    if (srmWidgetProfileMesgListeners.end() != it)
    srmWidgetProfileMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmDeviceSettingsMesgListener& srmDeviceSettingsMesgListener)
{
   srmDeviceSettingsMesgListeners.push_back(&srmDeviceSettingsMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmDeviceSettingsMesgListener& srmDeviceSettingsMesgListener)
{
    std::vector<SrmDeviceSettingsMesgListener *>::iterator it = std::find(srmDeviceSettingsMesgListeners.begin(), srmDeviceSettingsMesgListeners.end(), &srmDeviceSettingsMesgListener);
    if (srmDeviceSettingsMesgListeners.end() != it)
    srmDeviceSettingsMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(TbdFf0aMesgListener& tbdFf0aMesgListener)
{
   tbdFf0aMesgListeners.push_back(&tbdFf0aMesgListener);
}

void MesgBroadcaster::RemoveListener(TbdFf0aMesgListener& tbdFf0aMesgListener)
{
    std::vector<TbdFf0aMesgListener *>::iterator it = std::find(tbdFf0aMesgListeners.begin(), tbdFf0aMesgListeners.end(), &tbdFf0aMesgListener);
    if (tbdFf0aMesgListeners.end() != it)
    tbdFf0aMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(TbdFf0bMesgListener& tbdFf0bMesgListener)
{
   tbdFf0bMesgListeners.push_back(&tbdFf0bMesgListener);
}

void MesgBroadcaster::RemoveListener(TbdFf0bMesgListener& tbdFf0bMesgListener)
{
    std::vector<TbdFf0bMesgListener *>::iterator it = std::find(tbdFf0bMesgListeners.begin(), tbdFf0bMesgListeners.end(), &tbdFf0bMesgListener);
    if (tbdFf0bMesgListeners.end() != it)
    tbdFf0bMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmTotalsMesgListener& srmTotalsMesgListener)
{
   srmTotalsMesgListeners.push_back(&srmTotalsMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmTotalsMesgListener& srmTotalsMesgListener)
{
    std::vector<SrmTotalsMesgListener *>::iterator it = std::find(srmTotalsMesgListeners.begin(), srmTotalsMesgListeners.end(), &srmTotalsMesgListener);
    if (srmTotalsMesgListeners.end() != it)
    srmTotalsMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmSessionMesgListener& srmSessionMesgListener)
{
   srmSessionMesgListeners.push_back(&srmSessionMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmSessionMesgListener& srmSessionMesgListener)
{
    std::vector<SrmSessionMesgListener *>::iterator it = std::find(srmSessionMesgListeners.begin(), srmSessionMesgListeners.end(), &srmSessionMesgListener);
    if (srmSessionMesgListeners.end() != it)
    srmSessionMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmCompatibilityMesgListener& srmCompatibilityMesgListener)
{
   srmCompatibilityMesgListeners.push_back(&srmCompatibilityMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmCompatibilityMesgListener& srmCompatibilityMesgListener)
{
    std::vector<SrmCompatibilityMesgListener *>::iterator it = std::find(srmCompatibilityMesgListeners.begin(), srmCompatibilityMesgListeners.end(), &srmCompatibilityMesgListener);
    if (srmCompatibilityMesgListeners.end() != it)
    srmCompatibilityMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmIndoorSettingsMesgListener& srmIndoorSettingsMesgListener)
{
   srmIndoorSettingsMesgListeners.push_back(&srmIndoorSettingsMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmIndoorSettingsMesgListener& srmIndoorSettingsMesgListener)
{
    std::vector<SrmIndoorSettingsMesgListener *>::iterator it = std::find(srmIndoorSettingsMesgListeners.begin(), srmIndoorSettingsMesgListeners.end(), &srmIndoorSettingsMesgListener);
    if (srmIndoorSettingsMesgListeners.end() != it)
    srmIndoorSettingsMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmIndoorGearOffsetMesgListener& srmIndoorGearOffsetMesgListener)
{
   srmIndoorGearOffsetMesgListeners.push_back(&srmIndoorGearOffsetMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmIndoorGearOffsetMesgListener& srmIndoorGearOffsetMesgListener)
{
    std::vector<SrmIndoorGearOffsetMesgListener *>::iterator it = std::find(srmIndoorGearOffsetMesgListeners.begin(), srmIndoorGearOffsetMesgListeners.end(), &srmIndoorGearOffsetMesgListener);
    if (srmIndoorGearOffsetMesgListeners.end() != it)
    srmIndoorGearOffsetMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmWorkoutStepMesgListener& srmWorkoutStepMesgListener)
{
   srmWorkoutStepMesgListeners.push_back(&srmWorkoutStepMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmWorkoutStepMesgListener& srmWorkoutStepMesgListener)
{
    std::vector<SrmWorkoutStepMesgListener *>::iterator it = std::find(srmWorkoutStepMesgListeners.begin(), srmWorkoutStepMesgListeners.end(), &srmWorkoutStepMesgListener);
    if (srmWorkoutStepMesgListeners.end() != it)
    srmWorkoutStepMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmWorkoutInfoMesgListener& srmWorkoutInfoMesgListener)
{
   srmWorkoutInfoMesgListeners.push_back(&srmWorkoutInfoMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmWorkoutInfoMesgListener& srmWorkoutInfoMesgListener)
{
    std::vector<SrmWorkoutInfoMesgListener *>::iterator it = std::find(srmWorkoutInfoMesgListeners.begin(), srmWorkoutInfoMesgListeners.end(), &srmWorkoutInfoMesgListener);
    if (srmWorkoutInfoMesgListeners.end() != it)
    srmWorkoutInfoMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmWorkoutIntervalMesgListener& srmWorkoutIntervalMesgListener)
{
   srmWorkoutIntervalMesgListeners.push_back(&srmWorkoutIntervalMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmWorkoutIntervalMesgListener& srmWorkoutIntervalMesgListener)
{
    std::vector<SrmWorkoutIntervalMesgListener *>::iterator it = std::find(srmWorkoutIntervalMesgListeners.begin(), srmWorkoutIntervalMesgListeners.end(), &srmWorkoutIntervalMesgListener);
    if (srmWorkoutIntervalMesgListeners.end() != it)
    srmWorkoutIntervalMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmGatewayMesgListener& srmGatewayMesgListener)
{
   srmGatewayMesgListeners.push_back(&srmGatewayMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmGatewayMesgListener& srmGatewayMesgListener)
{
    std::vector<SrmGatewayMesgListener *>::iterator it = std::find(srmGatewayMesgListeners.begin(), srmGatewayMesgListeners.end(), &srmGatewayMesgListener);
    if (srmGatewayMesgListeners.end() != it)
    srmGatewayMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmGatewayCredentialsMesgListener& srmGatewayCredentialsMesgListener)
{
   srmGatewayCredentialsMesgListeners.push_back(&srmGatewayCredentialsMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmGatewayCredentialsMesgListener& srmGatewayCredentialsMesgListener)
{
    std::vector<SrmGatewayCredentialsMesgListener *>::iterator it = std::find(srmGatewayCredentialsMesgListeners.begin(), srmGatewayCredentialsMesgListeners.end(), &srmGatewayCredentialsMesgListener);
    if (srmGatewayCredentialsMesgListeners.end() != it)
    srmGatewayCredentialsMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmGatewayTokenMesgListener& srmGatewayTokenMesgListener)
{
   srmGatewayTokenMesgListeners.push_back(&srmGatewayTokenMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmGatewayTokenMesgListener& srmGatewayTokenMesgListener)
{
    std::vector<SrmGatewayTokenMesgListener *>::iterator it = std::find(srmGatewayTokenMesgListeners.begin(), srmGatewayTokenMesgListeners.end(), &srmGatewayTokenMesgListener);
    if (srmGatewayTokenMesgListeners.end() != it)
    srmGatewayTokenMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmNetworkStreamingMesgListener& srmNetworkStreamingMesgListener)
{
   srmNetworkStreamingMesgListeners.push_back(&srmNetworkStreamingMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmNetworkStreamingMesgListener& srmNetworkStreamingMesgListener)
{
    std::vector<SrmNetworkStreamingMesgListener *>::iterator it = std::find(srmNetworkStreamingMesgListeners.begin(), srmNetworkStreamingMesgListeners.end(), &srmNetworkStreamingMesgListener);
    if (srmNetworkStreamingMesgListeners.end() != it)
    srmNetworkStreamingMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmAltitudeOffsetMesgListener& srmAltitudeOffsetMesgListener)
{
   srmAltitudeOffsetMesgListeners.push_back(&srmAltitudeOffsetMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmAltitudeOffsetMesgListener& srmAltitudeOffsetMesgListener)
{
    std::vector<SrmAltitudeOffsetMesgListener *>::iterator it = std::find(srmAltitudeOffsetMesgListeners.begin(), srmAltitudeOffsetMesgListeners.end(), &srmAltitudeOffsetMesgListener);
    if (srmAltitudeOffsetMesgListeners.end() != it)
    srmAltitudeOffsetMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmSummaryDbMesgListener& srmSummaryDbMesgListener)
{
   srmSummaryDbMesgListeners.push_back(&srmSummaryDbMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmSummaryDbMesgListener& srmSummaryDbMesgListener)
{
    std::vector<SrmSummaryDbMesgListener *>::iterator it = std::find(srmSummaryDbMesgListeners.begin(), srmSummaryDbMesgListeners.end(), &srmSummaryDbMesgListener);
    if (srmSummaryDbMesgListeners.end() != it)
    srmSummaryDbMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmFtpDbItemMesgListener& srmFtpDbItemMesgListener)
{
   srmFtpDbItemMesgListeners.push_back(&srmFtpDbItemMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmFtpDbItemMesgListener& srmFtpDbItemMesgListener)
{
    std::vector<SrmFtpDbItemMesgListener *>::iterator it = std::find(srmFtpDbItemMesgListeners.begin(), srmFtpDbItemMesgListeners.end(), &srmFtpDbItemMesgListener);
    if (srmFtpDbItemMesgListeners.end() != it)
    srmFtpDbItemMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmAutoFtpInfoMesgListener& srmAutoFtpInfoMesgListener)
{
   srmAutoFtpInfoMesgListeners.push_back(&srmAutoFtpInfoMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmAutoFtpInfoMesgListener& srmAutoFtpInfoMesgListener)
{
    std::vector<SrmAutoFtpInfoMesgListener *>::iterator it = std::find(srmAutoFtpInfoMesgListeners.begin(), srmAutoFtpInfoMesgListeners.end(), &srmAutoFtpInfoMesgListener);
    if (srmAutoFtpInfoMesgListeners.end() != it)
    srmAutoFtpInfoMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmGpsAltitudePointMesgListener& srmGpsAltitudePointMesgListener)
{
   srmGpsAltitudePointMesgListeners.push_back(&srmGpsAltitudePointMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmGpsAltitudePointMesgListener& srmGpsAltitudePointMesgListener)
{
    std::vector<SrmGpsAltitudePointMesgListener *>::iterator it = std::find(srmGpsAltitudePointMesgListeners.begin(), srmGpsAltitudePointMesgListeners.end(), &srmGpsAltitudePointMesgListener);
    if (srmGpsAltitudePointMesgListeners.end() != it)
    srmGpsAltitudePointMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmTorqueMesgListener& srmTorqueMesgListener)
{
   srmTorqueMesgListeners.push_back(&srmTorqueMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmTorqueMesgListener& srmTorqueMesgListener)
{
    std::vector<SrmTorqueMesgListener *>::iterator it = std::find(srmTorqueMesgListeners.begin(), srmTorqueMesgListeners.end(), &srmTorqueMesgListener);
    if (srmTorqueMesgListeners.end() != it)
    srmTorqueMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SrmWoCompatibilityMesgListener& srmWoCompatibilityMesgListener)
{
   srmWoCompatibilityMesgListeners.push_back(&srmWoCompatibilityMesgListener);
}

void MesgBroadcaster::RemoveListener(SrmWoCompatibilityMesgListener& srmWoCompatibilityMesgListener)
{
    std::vector<SrmWoCompatibilityMesgListener *>::iterator it = std::find(srmWoCompatibilityMesgListeners.begin(), srmWoCompatibilityMesgListeners.end(), &srmWoCompatibilityMesgListener);
    if (srmWoCompatibilityMesgListeners.end() != it)
    srmWoCompatibilityMesgListeners.erase(it);
}
...
void MesgBroadcaster::OnMesg(Mesg& mesg)
{
    ...
    switch (mesg.GetNum())
    {
        ...
        {
            SrmRecordMesg srmRecordMesg(mesg);
            for (int i=0; i < (int)srmRecordMesgListeners.size(); i++)
            srmRecordMesgListeners[i]->OnMesg(srmRecordMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_COMMENT:
        {
            SrmCommentMesg srmCommentMesg(mesg);
            for (int i=0; i < (int)srmCommentMesgListeners.size(); i++)
            srmCommentMesgListeners[i]->OnMesg(srmCommentMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_USER_PROFILE:
        {
            SrmUserProfileMesg srmUserProfileMesg(mesg);
            for (int i=0; i < (int)srmUserProfileMesgListeners.size(); i++)
            srmUserProfileMesgListeners[i]->OnMesg(srmUserProfileMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_BIKE_PROFILE:
        {
            SrmBikeProfileMesg srmBikeProfileMesg(mesg);
            for (int i=0; i < (int)srmBikeProfileMesgListeners.size(); i++)
            srmBikeProfileMesgListeners[i]->OnMesg(srmBikeProfileMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_WIFI_PROFILE:
        {
            SrmWifiProfileMesg srmWifiProfileMesg(mesg);
            for (int i=0; i < (int)srmWifiProfileMesgListeners.size(); i++)
            srmWifiProfileMesgListeners[i]->OnMesg(srmWifiProfileMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_DISPLAY_PROFILE:
        {
            SrmDisplayProfileMesg srmDisplayProfileMesg(mesg);
            for (int i=0; i < (int)srmDisplayProfileMesgListeners.size(); i++)
            srmDisplayProfileMesgListeners[i]->OnMesg(srmDisplayProfileMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_WIDGET_PROFILE:
        {
            SrmWidgetProfileMesg srmWidgetProfileMesg(mesg);
            for (int i=0; i < (int)srmWidgetProfileMesgListeners.size(); i++)
            srmWidgetProfileMesgListeners[i]->OnMesg(srmWidgetProfileMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_DEVICE_SETTINGS:
        {
            SrmDeviceSettingsMesg srmDeviceSettingsMesg(mesg);
            for (int i=0; i < (int)srmDeviceSettingsMesgListeners.size(); i++)
            srmDeviceSettingsMesgListeners[i]->OnMesg(srmDeviceSettingsMesg);
            break;
        }
        case FIT_MESG_NUM_TBD_FF0A:
        {
            TbdFf0aMesg tbdFf0aMesg(mesg);
            for (int i=0; i < (int)tbdFf0aMesgListeners.size(); i++)
            tbdFf0aMesgListeners[i]->OnMesg(tbdFf0aMesg);
            break;
        }
        case FIT_MESG_NUM_TBD_FF0B:
        {
            TbdFf0bMesg tbdFf0bMesg(mesg);
            for (int i=0; i < (int)tbdFf0bMesgListeners.size(); i++)
            tbdFf0bMesgListeners[i]->OnMesg(tbdFf0bMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_TOTALS:
        {
            SrmTotalsMesg srmTotalsMesg(mesg);
            for (int i=0; i < (int)srmTotalsMesgListeners.size(); i++)
            srmTotalsMesgListeners[i]->OnMesg(srmTotalsMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_SESSION:
        {
            SrmSessionMesg srmSessionMesg(mesg);
            for (int i=0; i < (int)srmSessionMesgListeners.size(); i++)
            srmSessionMesgListeners[i]->OnMesg(srmSessionMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_COMPATIBILITY:
        {
            SrmCompatibilityMesg srmCompatibilityMesg(mesg);
            for (int i=0; i < (int)srmCompatibilityMesgListeners.size(); i++)
            srmCompatibilityMesgListeners[i]->OnMesg(srmCompatibilityMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_INDOOR_SETTINGS:
        {
            SrmIndoorSettingsMesg srmIndoorSettingsMesg(mesg);
            for (int i=0; i < (int)srmIndoorSettingsMesgListeners.size(); i++)
            srmIndoorSettingsMesgListeners[i]->OnMesg(srmIndoorSettingsMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_INDOOR_GEAR_OFFSET:
        {
            SrmIndoorGearOffsetMesg srmIndoorGearOffsetMesg(mesg);
            for (int i=0; i < (int)srmIndoorGearOffsetMesgListeners.size(); i++)
            srmIndoorGearOffsetMesgListeners[i]->OnMesg(srmIndoorGearOffsetMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_WORKOUT_STEP:
        {
            SrmWorkoutStepMesg srmWorkoutStepMesg(mesg);
            for (int i=0; i < (int)srmWorkoutStepMesgListeners.size(); i++)
            srmWorkoutStepMesgListeners[i]->OnMesg(srmWorkoutStepMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_WORKOUT_INFO:
        {
            SrmWorkoutInfoMesg srmWorkoutInfoMesg(mesg);
            for (int i=0; i < (int)srmWorkoutInfoMesgListeners.size(); i++)
            srmWorkoutInfoMesgListeners[i]->OnMesg(srmWorkoutInfoMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_WORKOUT_INTERVAL:
        {
            SrmWorkoutIntervalMesg srmWorkoutIntervalMesg(mesg);
            for (int i=0; i < (int)srmWorkoutIntervalMesgListeners.size(); i++)
            srmWorkoutIntervalMesgListeners[i]->OnMesg(srmWorkoutIntervalMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_GATEWAY:
        {
            SrmGatewayMesg srmGatewayMesg(mesg);
            for (int i=0; i < (int)srmGatewayMesgListeners.size(); i++)
            srmGatewayMesgListeners[i]->OnMesg(srmGatewayMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_GATEWAY_CREDENTIALS:
        {
            SrmGatewayCredentialsMesg srmGatewayCredentialsMesg(mesg);
            for (int i=0; i < (int)srmGatewayCredentialsMesgListeners.size(); i++)
            srmGatewayCredentialsMesgListeners[i]->OnMesg(srmGatewayCredentialsMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_GATEWAY_TOKEN:
        {
            SrmGatewayTokenMesg srmGatewayTokenMesg(mesg);
            for (int i=0; i < (int)srmGatewayTokenMesgListeners.size(); i++)
            srmGatewayTokenMesgListeners[i]->OnMesg(srmGatewayTokenMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_NETWORK_STREAMING:
        {
            SrmNetworkStreamingMesg srmNetworkStreamingMesg(mesg);
            for (int i=0; i < (int)srmNetworkStreamingMesgListeners.size(); i++)
            srmNetworkStreamingMesgListeners[i]->OnMesg(srmNetworkStreamingMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_ALTITUDE_OFFSET:
        {
            SrmAltitudeOffsetMesg srmAltitudeOffsetMesg(mesg);
            for (int i=0; i < (int)srmAltitudeOffsetMesgListeners.size(); i++)
            srmAltitudeOffsetMesgListeners[i]->OnMesg(srmAltitudeOffsetMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_SUMMARY_DB:
        {
            SrmSummaryDbMesg srmSummaryDbMesg(mesg);
            for (int i=0; i < (int)srmSummaryDbMesgListeners.size(); i++)
            srmSummaryDbMesgListeners[i]->OnMesg(srmSummaryDbMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_FTP_DB_ITEM:
        {
            SrmFtpDbItemMesg srmFtpDbItemMesg(mesg);
            for (int i=0; i < (int)srmFtpDbItemMesgListeners.size(); i++)
            srmFtpDbItemMesgListeners[i]->OnMesg(srmFtpDbItemMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_AUTO_FTP_INFO:
        {
            SrmAutoFtpInfoMesg srmAutoFtpInfoMesg(mesg);
            for (int i=0; i < (int)srmAutoFtpInfoMesgListeners.size(); i++)
            srmAutoFtpInfoMesgListeners[i]->OnMesg(srmAutoFtpInfoMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_GPS_ALTITUDE_POINT:
        {
            SrmGpsAltitudePointMesg srmGpsAltitudePointMesg(mesg);
            for (int i=0; i < (int)srmGpsAltitudePointMesgListeners.size(); i++)
            srmGpsAltitudePointMesgListeners[i]->OnMesg(srmGpsAltitudePointMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_TORQUE:
        {
            SrmTorqueMesg srmTorqueMesg(mesg);
            for (int i=0; i < (int)srmTorqueMesgListeners.size(); i++)
            srmTorqueMesgListeners[i]->OnMesg(srmTorqueMesg);
            break;
        }
        case FIT_MESG_NUM_SRM_WO_COMPATIBILITY:
        {
            SrmWoCompatibilityMesg srmWoCompatibilityMesg(mesg);
            for (int i=0; i < (int)srmWoCompatibilityMesgListeners.size(); i++)
            srmWoCompatibilityMesgListeners[i]->OnMesg(srmWoCompatibilityMesg);
            break;
        }
